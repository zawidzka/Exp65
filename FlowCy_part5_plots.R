...
# set workingDir
workingDir <- "220107_WorkingDirectory"
...
ggsave("abundances_stat.pdf", plot = last_plot(), dpi = 300, width = 6, height = 5)
...
CATALYST::plotDR(sce, dr = "UMAP", color_by = c("TCF1", "PD1", "TIM3", "EOMES", "Tbet","CD44", "CD62L", "CX3CR1", "Ly108", "CD101"), facet_by = "condition")
...
ggsave("UMAP_bymarker.pdf", height = 20, width = 20, plot = last_plot())
...
pdf("Multiheatmap_allCD8alltissues.pdf", width = 14, height = 10)
plotMultiHeatmap(sce, k = "cluster_annotation", hm1 = type_markers(sce), 
                 hm2 = "abundances", bars = FALSE, perc = FALSE, 
